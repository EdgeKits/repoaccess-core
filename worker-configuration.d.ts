/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: a1d7ca95e32b05f0e7aa4f30bfcc3b0b)
// Runtime types generated with workerd@1.20260730.1 2026-06-13 
interface __BaseEnv_CloudflareBindings {
	ENTITLEMENTS: KVNamespace;
	ASSETS: Fetcher;
	GITHUB_TOKEN: string;
	STRIPE_WEBHOOK_SECRET: string;
	CLAIM_GUARD: DurableObjectNamespace<import("./src/index").ClaimGuard>;
	ACCESS_WORKFLOW: Workflow<Parameters<import("./src/index").AccessWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ClaimGuard";
	}
